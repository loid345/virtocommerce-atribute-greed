...
using VirtoCommerce.AttributeGrid.Data.SqlServer;

namespace VirtoCommerce.AttributeGrid.Web;
...
public class Module : IModule, IHasConfiguration
{
    ...
    {
        serviceCollection.AddDbContext<AttributeGridDbContext>(options =>
        {
    ...
    public void PostInitialize(IApplicationBuilder appBuilder)
    {
        ...
        using var dbContext = serviceScope.ServiceProvider.GetRequiredService<AttributeGridDbContext>();
